...
import {Autocomplete, Box, Button, Chip, Container, Grid, Input, Stack, TextField, Typography} from "@mui/material";
import IngredientInput from "../../components/IngredientInput.jsx";
import StepInput from "../../components/StepInput.jsx";

const EditGlobalRecipe = () => {
    const { id } = useParams();
    ...
    function editRecipe(data) {
        ...
        return fetch(`http://localhost:8000/api/globalrecipes/${id}/update`, {
            method: 'PUT',
            headers: {
                'X-CSRFToken': getCSRFToken(),
            },
                ...
                <Grid container spacing={25} sx={{justifyContent: 'center', paddingTop: '3em'}}>
                    <Grid item xs={12} md={6}>
                        <Stack spacing={3}>
                            ...
                            <TextField id={'calories'} name={'calories'} onChange={(e) => setCalories(e.target.value)} value={calories}/>
                        </Stack>
                    </Grid>
                    <Grid item xs={12} md={6}>
                        <Stack spacing={2}>
...
export default EditGlobalRecipe;